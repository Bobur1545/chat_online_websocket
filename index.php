...
<script language="javascript" type="text/javascript">
    ...
    websocket.onopen = function(ev) { // boglanish ochiladi
        msgBox.append('<div class="system_msg" style="color:#bbbbbb">Welcome to my "Demo WebSocket Chat box"!</div>'); //notify user
    }
    // serverdan xabar qaul qilish uchun
    websocket.onmessage = function(ev) {
        var response 		= JSON.parse(ev.data); //php json maumot yuvaradi

        var res_type 		= response.type; //message turi
